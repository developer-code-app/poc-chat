...
class MarbleTheme extends app_theme.AppTheme {
  MarbleTheme({app_theme.PageSize? pageSize})
      : super(
    ...
    wallpaper = Assets.images.wallpaperMarble.provider();
    isDarkTheme = false;
  }

  @override
  app_theme.AppTheme theme(app_theme.PageSize pageSize) =>
      MarbleTheme(pageSize: pageSize);
